...
start	di : ld sp, $-2
	...
	ld bc, #02ff : ld (hl), #47 : ldir	

	call swap_screen
	ld hl, #c000 : ld de, #c001 : ld bc, #1800 : ld (hl), l : ldir
	ld bc, #02ff : ld (hl), #07 : ldir
...
main	
	...
	// fade in	
	ld b, #16		; количество итераций
fin_outer	push bc
	call chnk_main.INC_BRGHT
	ld b, #08		; внутри каждой интерации прокручиваем N раз анимацию для замедления эффекта
	halt : djnz $-1
